...
def _string_list(value: object) -> list[str]:
    """Normalize untrusted persisted collection fields for safe rendering."""
...
def _build_handoff_payload(request: WorkerRequest) -> dict[str, object]:
    ...
    changed_files = _string_list(coding_outputs.get("changed_files"))
    residual_risks = _string_list(validation_outputs.get("residual_risks"))
    ...
    return {
        ...
        "validation_fulfilled": _string_list(validation_outputs.get("fulfilled")),
...
def _build_handoff_markdown(payload: dict[str, object]) -> str:
    ...
    fulfilled = _string_list(payload.get("validation_fulfilled"))
    residual_risks = _string_list(payload.get("validation_residual_risks"))
