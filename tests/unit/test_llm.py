...
def _settings_with_routing(tmp_path: Path, monkeypatch: pytest.MonkeyPatch, routing_yaml: str) -> Settings:
    ...
    monkeypatch.setenv("LLM_TIMEOUT_CONNECT_SECONDS", "0.5")
    monkeypatch.setenv("LLM_TIMEOUT_READ_SECONDS", "0.5")
    monkeypatch.setenv("LLM_TIMEOUT_WRITE_SECONDS", "0.5")
    monkeypatch.setenv("LLM_TIMEOUT_POOL_SECONDS", "0.5")
